package com.dev.tvtoyou.managers

import android.app.Application
import com.dev.tvtoyou.apis.Video
import com.dev.tvtoyou.models.Channel
import com.dev.tvtoyou.services.Media
...
class PlaylistManager(application: Application) :
    ListPlaylistManager<Channel>(application, Media::class.java) {
     ...
     */
    fun addVideoApi(videoApi: Video) {
     ...
     */
    fun removeVideoApi(videoApi: Video) {
     ...
     */
    private fun updateVideoControls(videoApi: Video) {
